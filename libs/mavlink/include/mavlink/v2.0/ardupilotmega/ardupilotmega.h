...
#define MAVLINK_ARDUPILOTMEGA_XML_HASH 5668092619210133704
...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_DO_SET_EMERGENCY=225, /* Used to set/unset emergency status for remote id. |Set/unset emergency 0: unset, 1: set| Empty| Empty| Empty| Empty| Empty| Empty|  */
