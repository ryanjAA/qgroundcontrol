...
SetupPage {
    ...
    Component {
        ...
        Item {
            ...
            property var            _activeCamJoystick:        joystickManager.activeCamJoystick
            ...
            property var pages:  ["qrc:/nvqml/CamJoystickConfigGeneral.qml", "qrc:/nvqml/CamJoystickConfigButtons.qml"]
