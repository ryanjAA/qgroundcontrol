...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(windowShade,          "#d9d9d9", "#d9d9d9", "#343a40", "#343a40")
    ...
    DECLARE_QGC_COLOR(buttonHighlight,      "#439BD6", "#439BD6", "#439BD6", "#439BD6")
    ...
    DECLARE_QGC_COLOR(primaryButton,        "#585858", "#439BD6", "#585858", "#439BD6")
    ...
    DECLARE_QGC_COLOR(toolStripHoverColor,  "#439BD6", "#439BD6", "#439BD6", "#439BD6")
    ...
    //                                              Disabled    Enabled
    DECLARE_QGC_NONTHEMED_COLOR(brandingPurple,     "#439BD6", "#439BD6")
