...
DECLARE_SETTINGSFACT(AppSettings, virtualJoystickShowZoom)
DECLARE_SETTINGSFACT(AppSettings, showFullScreenButton)
DECLARE_SETTINGSFACT(AppSettings, localPositionRoll)
DECLARE_SETTINGSFACT(AppSettings, localPositionPitch)
DECLARE_SETTINGSFACT(AppSettings, globalPositionElevation)
DECLARE_SETTINGSFACT(AppSettings, globalPositionAzimuth)
DECLARE_SETTINGSFACT(AppSettings, camJoystickDZ)
DECLARE_SETTINGSFACT(AppSettings, camJoystickGain)
DECLARE_SETTINGSFACT(AppSettings, quickViewMode)
DECLARE_SETTINGSFACT(AppSettings, camControlFontSize)
DECLARE_SETTINGSFACT(AppSettings, nvVideoChannel)
DECLARE_SETTINGSFACT(AppSettings, telementryValuesBarLocation)
